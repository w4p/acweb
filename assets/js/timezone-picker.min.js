...
"use strict";
!function (e, n) {
  if ("function" == typeof define && define.amd) define(["moment", "jquery"], function (o, t) {
    e.worldMapTime = {}, n(o, t, e.worldMapTime)
  }); else {
    if ("undefined" == typeof e.moment) {
      var o = !1;
      console.log("Day light feature requires moment.js")
    } else if (!e.moment.tz) throw new Error("moment-timezone dependency not found");
    if ("undefined" == e.jQuery && "undefined" == e.Zepto && "undefined" == e.ender && "undefined" == e.$) throw new Error("jQuery dependnecy not found");
    var t = e.worldMapTime = {};
    n(e.moment || o, e.jQuery || e.Zepto || e.ender || e.$, t)
  }
}(this, function (e, n, o) {
  function t(e) {
    return this.each(function () {
      var o = n(this), t = n.extend({}, a.DEFAULTS, o.data(), "object" == typeof e && e);
      if (t.mapHover && (!t.mapHover || "timezone" !== t.mapHover && "country" !== t.mapHover && "zonename" !== t.mapHover)) throw new Error("map Hover value should have timezone or country or zone name if it is string or pass null for default behaviour");
      o.data("timezonePicker", new a(o, t)), o.trigger("map:loaded")
    })
  }

  var i = function (e, o) {
    for (var t = [], i = (a.timeZoneValue.filter(function (i) {
      return i[e] === o ? (t.push(n.extend(!0, {}, i)), i) : void 0
    }), 0); i < t.length; i++) delete t[i].points, delete t[i].pin;
    return t
  };
  o.getSystemTimezone = function () {
    var e = (new Date).toString().split("(")[1].slice(0, -1);
    return i("zoneName", e)
  }, o.getZoneName = function (e) {
    return i("zoneName", e).zoneName
  }, o.getTimeZoneString = function (e) {
    return i("zoneName", e).timezone
  }, o.getTimeZoneObject = function (e) {
    return i("zoneName", e)
  };
  var a = function (e, n) {
    this.$el = e, this.generateMap(n)
  };
  a.VERSION = "1.0.0", a.DEFAULTS = {
    width: 500,
    height: 250,
    hoverColor: "#5A5A5A",
    ...
    defaultCss: !0,
    localStore: !0,
    quickLink: [{IST: "IST", EAT: "EAT"}],
    selectBox: !0,
    showHoverText: !0,
    hoverText: null,
    dayLightSaving: "function" == typeof e ? !0 : !1
  }, a.prototype = {
    constructor: a, setValue: function (e, n) {
      this.$el.find("svg polygon").attr("data-selected", "false");
      var o = this.$el.find("svg polygon[data-" + (n ? n : "timezone") + '="' + e + '"]');
      if (o && o.length) {
        o.attr("data-selected", "true"), this.$el.find('select option[value="' + (n ? o.attr("data-timeZone") : e) + '"]').prop("selected", !0), this.$el.find(".quickLink span").removeClass("active");
        this.$el.find('.quickLink span[data-select="' + e + '"]');
        this.$el.find('.quickLink span[data-select="' + e + '"]').addClass("active"), this.$el.find('.quickLink span[data-select="' + o.attr("data-zonename") + '"]').addClass("active")
      }
    }, getValue: function () {
      var e = [];
      return this.$el.find('svg polygon[data-selected="true"]').map(function (o, t) {
        e.push(n(t).data())
      }), e
    }, generateMap: function (n) {
      var o = [], t = [], i = [], s = [], m = a.timeZoneValue;
      for (var r in m) o.push(this.genrateElement("polygon", {
        "data-timezone": m[r].timezone,
        "data-country": m[r].country,
        "data-pin": m[r].pin,
        "data-offset": m[r].offset,
        points: m[r].points,
        "data-zonename": n.dayLightSaving ? e().tz(m[r].timezone).zoneName() : m[r].zoneName
      }, !1, !0)), t.push(this.genrateElement("option", {value: m[r].timezone}, m[r].timezone + " (" + (n.dayLightSaving ? e().tz(m[r].timezone).zoneName() : m[r].zoneName) + ")"));
      if (n.selectBox) {
        var f = this.genrateElement("select", {"class": "btn btn-default dropdown-toggle"}, t);
        s.push(f)
      }
      if (n.quickLink.length > 0) {
        for (var r in n.quickLink[0]) i.push(this.genrateElement("span", {"data-select": n.quickLink[0][r]}, r));
        var p = this.genrateElement("div", {"class": "quickLink"}, i);
        s.push(p)
      }
      var z = this.genrateElement("svg", {"class": "timezone-map", viewBox: "0 0 " + n.width + " " + n.height}, o, !0);
      if (s.length > 0) {
        var c = this.genrateElement("div", {"class": "Cbox"}, s);
        this.$el.append(c)
      }
      if (this.$el.append(z), n.showHoverText) {
        var u = this.genrateElement("span", {"class": "hoverZone"});
        this.$el.append(u)
      }
      n.defaultCss && this.createCss(n), this.bindEvent(n)
    }, bindEvent: function (e) {
      var o = this;
      this.$el.on("mouseenter", "svg polygon", function (t) {
        var i = null, a = n(this).data(), s = e.mapHover, m = e.hoverText;
        i = n(s ? ".timezone-map polygon[data-" + s + '="' + a[s] + '"]' : t.currentTarget), i.attr("class", "active"), o.$el.find(".hoverZone").text(m ? m instanceof Function ? m(t) : m : a.timezone + " (" + a.zonename + ")")
      }), this.$el.on("mouseleave", "svg polygon", function (e) {
        n(".timezone-map polygon").attr("class", ""), o.$el.find(".hoverZone").text("")
      }), this.$el.on("click", "svg polygon", function () {
        o.setValue(n(this).attr("data-timezone")), o.$el.trigger("map:clicked")
      }), this.$el.on("change", "select", function () {
        o.setValue(n(this).val()), o.$el.trigger("map:clicked")
      }), this.$el.on("click", ".quickLink span", function () {
        var e = n(this).data().select;
        e.search("/") > 0 ? o.setValue(e, "timezone") : o.setValue(e, "zonename"), o.$el.trigger("map:clicked")
      })
    }, genrateElement: function (e, n, o, t) {
      if (t) var i = document.createElementNS("http://www.w3.org/2000/svg", e); else var i = document.createElement(e);
      if (n) for (var a in n) i.setAttribute(a, n[a]);
      if (o) if (o instanceof Array) for (var s in o) i.appendChild(o[s]); else "string" == typeof o ? i.innerHTML = o : i.appendChild(o);
      return i
    }, createCss: function (e) {
      var n = document.createElement("style");
      n.type = "text/css", n.innerHTML = '.timezone-map polygon[data-selected="true"] {fill: ' + e.selectedColor + "}.timezone-map polygon { fill: " + e.mapColor + ";}.timezone-map polygon.active {fill: " + e.hoverColor + ";}.timezone-map polygon:hover { cursor: pointer;}.Cbox .quickLink{width: 52%;float: right;padding-bottom: 11px;overflow-x: auto; white-space: nowrap;overflow-y: hidden;}.Cbox .quickLink span:hover {color:#FFF;background-color: #496A84;  cursor: pointer;}.Cbox select{width: 45%;float: left;height: 27px; padding: 0px 0px 0px 10px;}.Cbox .quickLink span.active {color: #FFF; background-color: #496A84;}.Cbox .quickLink span{ font-weight: 300; border-radius: 3px; color: #000; background-color: #FFF; border: solid 1px #CCC;margin-left: 10px;font-size: 9px;padding: 4px 6px 4px 6px;}", document.getElementsByTagName("head")[0].appendChild(n)
    }
  }, n.fn.timezonePicker = t, a.timeZoneValue = [{
    ...
    timezone: "America/Glace_Bay", country: "CA", pin: "167,61", offset: -4, points: "167,61,166,61,166,61,167,61",
    zoneName: "AST"
  }, {
  ...
  //   zoneName: "WAKT"
  // }, {timezone: "Pacific/Wallis", country: "WF", pin: "5,143", offset: 12, points: "-3,150,10,138", zoneName: "WFT"}
  ]
});
